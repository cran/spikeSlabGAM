...
tools:::texi2dvi("UsingSpikeSlabGAM.tex", pdf=T)
@
...
\emph{Note: This introduction to \pkg{spikeSlabGAM} is currently under revision at 
...
An anonymous referee at JSS revigorated the author's faith in the peer review process with his diligent 
